...
def audio_tagging(args):
    ...
    for k in range(len(sorted_indexes)):
        if verbose:
            print('{} ({}): {:.3f}'.format(np.array(labels)[sorted_indexes[k]], config.ids[sorted_indexes[k]],
    ...
    return clipwise_output, labels, config.ids
...
if __name__ == '__main__':
    ...
    parser_at.add_argument('--verbose', type=bool, default=True)
